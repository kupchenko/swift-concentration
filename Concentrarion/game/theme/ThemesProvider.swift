...
struct ThemesProvider {
    private var themes = Dictionary<String, Theme>()
    
    private(set) static var defaultTheme = Theme(title: "other",
                                    emojiList: ["👻", "🎃", "👑", "🐒", "👽", "🤡", "⛄️", "🏀", "❤️", "☂️", "🐳", "💩", "🧠", "🍄", "🎪"],
    ...
    init() {
        ...
        themes[ThemesProvider.defaultTheme.title] = ThemesProvider.defaultTheme
